      ...
      {loading && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[320px] h-[320px] md:w-[550px] md:h-[550px] rounded-full bg-gradient-to-tr from-neutral-300/20 via-neutral-400/20 to-neutral-500/20 filter blur-[90px] md:blur-[140px] pointer-events-none"
          />
          ...
          >
            ...
            <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 flex items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="w-full h-full rounded-full border-[3.5px] border-neutral-300 border-t-neutral-900 border-r-neutral-700 shadow-[0_0_35px_rgba(0,0,0,0.15)]"
              />
              ...
              <motion.div
                ...
                className="absolute w-3/4 h-3/4 rounded-full border-[2.5px] border-transparent border-b-neutral-900/80 border-l-neutral-600/80"
              />
              ...
              <motion.div
                ...
                className="absolute w-2/5 h-2/5 rounded-full bg-gradient-to-tr from-neutral-800/40 to-neutral-500/40 filter blur-xs"
              />
            </div>
            ...
            >
              ...
              <p className="text-[10px] sm:text-sm md:text-base text-neutral-500 uppercase tracking-[0.3em] sm:tracking-[0.4em] font-extrabold whitespace-nowrap">
