      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "absolute mt-1.5 min-w-[12rem] w-max max-w-[calc(100vw-2rem)] rounded-2xl bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border border-slate-300/90 dark:border-white/25 shadow-xl shadow-slate-900/10 dark:shadow-black/40 p-1.5 z-[9999]",
              alignmentClass,
              originClass
            )}
          >
