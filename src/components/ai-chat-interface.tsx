...
export function AIChatInterface() {
  ...
  return (
    <div className="flex flex-col h-[70vh] sm:h-[72vh] lg:h-[75vh] w-full border border-slate-200/80 dark:border-white/25 rounded-2xl sm:rounded-3xl bg-card/30 dark:bg-slate-900/40 backdrop-blur-sm p-2.5 sm:p-4 shadow-sm overflow-hidden">
