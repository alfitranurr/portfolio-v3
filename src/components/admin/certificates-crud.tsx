                ...
                <table className="w-full min-w-[750px] text-left text-xs table-auto">
                  <thead className="bg-slate-100/50 dark:bg-slate-900/60 border-b border-slate-200/10 dark:border-slate-800/20 uppercase tracking-wider font-extrabold text-[10px] text-muted-foreground">
                    <tr>
                      ...
                      <th className="py-2.5 px-3 min-w-[220px]">Certificate Title & Issuer</th>
                      ...
                      <th className="py-2.5 px-3 whitespace-nowrap text-center">Credential ID</th>
                      <th className="py-2.5 px-3 text-center whitespace-nowrap w-40">Actions</th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="py-2.5 px-3">
                          <div className="flex items-center gap-2.5 min-w-0">
                            {cert.image_url ? (
                              <div className="w-10 h-7 rounded-lg overflow-hidden bg-slate-900 border border-slate-700/60 shrink-0 relative shadow-xs">
                                <BlurImage
                              ...
                              <div className="w-10 h-7 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0 text-primary">
                        ...
                        <td className="py-2.5 px-3 whitespace-nowrap text-center">
                          {cert.credential_id ? (
                            <span 
                              className="font-mono text-[10px] px-2 py-0.5 rounded-md bg-slate-800/60 border border-slate-700/50 text-slate-300 inline-block tracking-tight max-w-[140px] truncate"
