  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col space-y-3 sm:space-y-4 w-full animate-in fade-in duration-200">
      ...
      <div className="flex items-center justify-between gap-3 shrink-0">
        ...
        <div className="flex items-center gap-2.5 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-2xl glass-card border border-slate-200/80 dark:border-white/25">
      ...
      <div className="flex-1 min-h-0 rounded-3xl glass-panel border border-slate-200/10 dark:border-white/15 p-3 sm:p-5 flex flex-col justify-between shimmer-card overflow-hidden">
        ...
        {/* Input area mockup */}
        <div className="pt-3 border-t border-slate-200/10 dark:border-white/15">
