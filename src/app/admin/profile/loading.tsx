  ...
  return (
    <div className="space-y-8 w-full animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 md:p-8 rounded-3xl glass-panel border border-slate-200/10 dark:border-white/15 space-y-5 shimmer-card">
          <div className="space-y-1.5 pb-2 border-b border-slate-200/10 dark:border-white/15">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 md:p-8 rounded-3xl glass-panel border border-slate-200/10 dark:border-white/15 space-y-4 shimmer-card">
            <div className="space-y-1.5 pb-2 border-b border-slate-200/10 dark:border-white/15">
